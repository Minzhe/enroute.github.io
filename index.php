        ...
        <div class="row">
            ...
            <div class="4u" id="featured">
                <div class="index-right">
                    <h3>News</h3>
                    <p style="text-align: justify; font-size: 14px;">10/10/18 GeNeCK 1.0 released.</p>
                    <p style="text-align: justify; font-size: 14px;">03/01/18 GeNeCK paper was submitted.</p>
                    <p style="text-align: justify; font-size: 14px;">07/01/17 GeNeCK beta released.</p>
                </div>
                <hr/>
                <div class="index-right">
                    <h3>Citations</h3>
